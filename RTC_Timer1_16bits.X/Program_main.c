...
{
    INTCON = 0xC0;      /* GIE/GIEH = 1     - Habilita Interrupção Global
                         * PEIE/GIEL = 1    - Habilita Interrupção de periféricos
                         * TMR0IE = 0       - Habilita Interrupção pelo TIMER0
                         ...
                         * RBIE = 0         - Não utilizado
                         */
    PIE1bits.TMR1IE = 1;  // Habilita interrupção para o modulo TIMER1
}
void config_TIMER1()
{
    ...
    T1CON = 0X8F;       /* RD16 = 1         - Habilita modo 16bits                     
                         ...
                         * T1SYNC = 1       - Não de aplica
                         * TMR1CS = 1       - Fonte de clock externa
                         * TMR1ON = 1       - Módulo do TIMER1 habilitado
                         */
    TMR1H = 0X80;       
